...
#"similarChem":[]
#"similarContacts":[]
def createHtmlReport(outFile, results, maxsimil=2, maxOutComp = 100, iwidth=150, iheight=150):
	templateDef=''.join(open('template.html').readlines())
	nameSpace = {'maxSimilar':maxsimil, "results": results[:maxOutComp], "iwidth":iwidth, "iheight":iheight}
